...
MONSTERS = {
    ...
    "crypt_ghoul":    dict(name="Crypt Ghoul",      sprite="crypt_ghoul",     min_d=7,  max_d=16, freq=9,  hp=54,  ac=9,  hit=8,  dmg=(2, 6), speed=90,  xp=56,  ai="melee", poison=5, undead=True),
    ...
    "pale_wraith":    dict(name="Pale Wraith",      sprite="pale_wraith",     min_d=10, max_d=20, freq=8,  hp=62,  ac=11, hit=10, dmg=(2, 7), speed=90,  xp=105, ai="erratic", drain=True, undead=True),
    ...
    "iron_revenant":  dict(name="Iron Revenant",    sprite="iron_revenant",   min_d=18, max_d=25, freq=7,  hp=240, ac=19, hit=16, dmg=(4, 7), speed=100, xp=380, ai="melee", undead=True),
