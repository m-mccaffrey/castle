...
MONSTERS = {
    ...
    "goblin":         dict(name="Goblin",           sprite="goblin",          min_d=2,  max_d=9,  freq=11, hp=20,  ac=6,  hit=4,  dmg=(1, 6), speed=100, xp=14,  ai="melee", pack=(2, 4)),
    ...
    "stone_golem":    dict(name="Stone Golem",      sprite="stone_golem",     min_d=13, max_d=23, freq=7,  hp=185, ac=18, hit=11, dmg=(3, 7), speed=170, xp=195, ai="brute", knockback=2, construct=True, fearless=True),
