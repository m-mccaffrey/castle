...
MONSTERS = {
    ...
    "ash_cultist":    dict(name="Ash Cultist",      sprite="ash_cultist",     min_d=6,  max_d=16, freq=8,  hp=36,  ac=7,  hit=7,  dmg=(1, 8), speed=100, xp=46,  ai="caster", rng=7, bolt="fire", element="fire"),
    ...
    "ember_drake":    dict(name="Ember Drake",      sprite="ember_drake",     min_d=16, max_d=25, freq=7,  hp=165, ac=15, hit=14, dmg=(3, 8), speed=80,  xp=290, ai="archer", rng=6, bolt="fire", element="fire", burn=True),
